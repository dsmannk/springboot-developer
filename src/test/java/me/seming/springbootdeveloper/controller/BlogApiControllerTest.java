...
import me.seming.springbootdeveloper.dto.AddArticleRequest;
import me.seming.springbootdeveloper.dto.UpdateArticleRequest;
import me.seming.springbootdeveloper.repository.BlogRepository;
...
class BlogApiControllerTest {
    ...
    public void deleteArticle() throws Exception {
        ...
        // when
        mockMvc.perform(delete(url, savedArticle.getId())).andExpect(status().is(204));
